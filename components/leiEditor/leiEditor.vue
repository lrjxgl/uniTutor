<template>
	<view  style="border: 1px solid #eee;padding:5px; box-sizing: border-box;">
		<view  >
			<view class='leiEditor'>
				<view class='toolbar' @tap="format" style="height: 44px;overflow-y: auto;">
			...
			insertImage() {
				...
				uni.chooseImage({
					...
					success: (chooseImageRes) => {
						...
						uni.uploadFile({
							url: that.app.apiHost+"index.php?m=upload&a=img&ajax=1&authcode="+that.app.getAuthCode(), 
